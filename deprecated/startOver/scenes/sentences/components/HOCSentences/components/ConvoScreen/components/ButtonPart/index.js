 ...
 **/
class ButtonPart extends React.Component {
...
const mapStateToProps = (state, ownProps) => {
    let buttonInfo = sentencesStateSelectors.getButtonInfo(state);
...
export default connect(mapStateToProps, null)(ButtonPart);
